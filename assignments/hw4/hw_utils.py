...
def get_scorpion_search_grid(image_path='search_grid.png'):
    CELL_SIZE = 20
    ORIGIN_CELL = (16, 12)
    img = Image.open('search_grid.png')
    grid, img = plot_grid(img, cell_size=CELL_SIZE)
    return grid, img

def plot_scorpion_search_grid(image_path='search_grid.png', show=False):
...
def plot_scorpion_path(seq, img=None, grid=None, image_path='search_grid.png', show=False):
...
def plot_dist_on_scorpion_search_grid(dist, max_alpha=255, vmin=0.01, show=False, image_path='search_grid.png'):
    grid, img = get_scorpion_search_grid(image_path)
